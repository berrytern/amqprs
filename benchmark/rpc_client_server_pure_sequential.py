...
async def run():
    ...
    for _ in range(0, 300_000):
        await eventbus.rpc_client(exchange_name, routing_key, 'Hello, RPC!')
    after = time_ns()
    ...
    #Time taken for 300k messages: 182.964231006 seconds
    #Mean messages per second for 300k messages: 1639.6647495004747
asyncio.run(run())