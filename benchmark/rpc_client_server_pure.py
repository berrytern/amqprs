...
async def run():
    ...
    #await eventbus.subscribe(exchange_name, routing_key, handler, "application/json", None)
    ...
    for _ in range(0, 30):
        for _ in range(0, 10000):
            print("response:", await eventbus.rpc_client(exchange_name, routing_key, 'Hello, RPC!'))
    ...
    #Time taken for 300k messages: 189.382727451 seconds
    #Mean messages per second for 300k messages: 1584.0937768605145
asyncio.run(run())